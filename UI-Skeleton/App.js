...
// const HeadingComponent = () => <h1> React from Functional Component</h1>;

//                                      (or)

/* const HeadingComponent = () => (
    <h1 className="heading">
     React from Functional Component</h1>
   );
*/
...
//   return <h1 className="heading"> React using JSX🚀</h1>;
// };
